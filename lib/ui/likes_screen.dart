            ...
            return ListView.builder(
              ...
              itemBuilder: ((context, index) {
                return Padding(
                  ...
                  child: ListTile(
                    title: Text(
                      snapshot.data[index].data['ownerName'], style: TextStyle(
                        color: Colors.black,
                    ...
                    leading: CircleAvatar(
                      backgroundImage: NetworkImage(snapshot.data[index].data['ownerPhotoUrl']),
                      radius: 30.0,
                    ),
                    trailing: snapshot.data[index].data['ownerUid'] != widget.user.uid ? Container(
                      width: 60.0,
                      height: 30.0,
